...
#define APP_CONFIG_CAPTURE_BUFFER_BYTES (APP_CONFIG_SAMPLE_RATE * APP_CONFIG_PCM_FRAME_BYTES)
#define APP_CONFIG_TRANSPORT_BUFFER_BYTES (APP_CONFIG_CAPTURE_BUFFER_BYTES + 44)
#else
#define APP_CONFIG_CAPTURE_BUFFER_BYTES APP_CONFIG_MAX_PCM_BYTES
#define APP_CONFIG_TRANSPORT_BUFFER_BYTES APP_CONFIG_MAX_UPLOAD_BYTES
#endif
